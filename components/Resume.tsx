  ...
  return (
    <section id="resume" className="py-28 md:py-40">
      <div className="mx-auto w-[min(92%,1000px)]">
        <div className="glass-strong rounded-3xl p-10 md:p-16 grain relative overflow-hidden">
          <div
            className="absolute -top-24 -right-24 size-80 rounded-full opacity-30 blur-3xl"
            style={{ background: 'var(--color-accent)' }}
          />
          <p className="text-xs uppercase tracking-[0.25em] text-accent">
            06 — Résumé
          </p>
          <h2 className="mt-4 font-display text-4xl md:text-5xl font-light max-w-xl">
            Download my résumé.
          </h2>
